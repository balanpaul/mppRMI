...
public class ServerImpl implements IServer {
    ...
    private ZborJdbcRepository zborJdbcRepository;
    private BiletJdbcRepository biletJdbcRepository;
    private String username;
    private Agent userLogat;

    public ServerImpl(UserRepositoryJdbc userRepositoryJdbc, ZborJdbcRepository zborJdbcRepository, BiletJdbcRepository biletJdbcRepository) {
    ...
    public void updateZbor(Bilet bilet)throws AgentException,RemoteException{
        ...
        if (zbor != null) {
            ...
            zborJdbcRepository.update(zbor.getId(), z);
